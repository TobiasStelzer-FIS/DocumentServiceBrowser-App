sap.ui.define([
		...
		"de/fis/filebrowser/model/models",
		"de/fis/filebrowser/controller/ListSelector",
		"de/fis/filebrowser/controller/ErrorHandler"
	], function (UIComponent, Device, JSONModel, models, ListSelector, ErrorHandler) {
		"use strict";

		return UIComponent.extend("de.fis.filebrowser.Component", {
			...
			init : function () {
				...
				this.sRootPath = "/TraineeReportsService/browse";
